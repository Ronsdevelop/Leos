...
<html lang="es">
    <head>
        ...
        <!--========== CSS ==========-->
        <link rel="stylesheet" href=" {{ asset('assets/welcome/css/styles.css') }}">
            ...
            <section class="menu section bd-container" id="menu">
                ...
                <div class="menu__container bd-grid">
                    <div class="menu__content">
                        <img src="{{ asset('assets/welcome/img/plate1.png')}}" alt="" class="menu__img">
                    ...
                    <div class="menu__content">
                        <img src="{{ asset('assets/welcome/img/plate2.png')}}" alt="" class="menu__img">
                    ...
                    <div class="menu__content">
                        <img src="{{ asset('assets/welcome/img/plate3.png')}}" alt="" class="menu__img">
                ...
                <div class="app__container bd-grid">
                    <div class="app__data">
                        ...
                        <div class="app__stores">
                            <a href="#"><img src="{{ asset('assets/welcome/img/app1.png')}}" alt="" class="app__store"></a>
                            <a href="#"><img src="{{ asset('assets/welcome/img/app2.png')}}" alt="" class="app__store"></a>
                        </div>
                    </div>

                    <img src="{{ asset('assets/welcome/img/movil-app.png')}}" alt="" class="app__img">
                </div>
            </section>
