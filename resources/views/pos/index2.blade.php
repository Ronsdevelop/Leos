                                ...
                                <div class="well well-sm">
                                    ...
                                    <div id="pay-button" class="text-center">
                                        <div class="btn-group btn-group-justified">
                                            <div class="btn-group">
                                                <button   onClick="return false;" class="btn btn-warning btn-block" data-loading-text="Processing..." title="Payment">
                                                    <span class="fa fa-fw fa-money"></span>
                                                    PAGA
                                                </button>
                                            </div>
...
<link rel="stylesheet" href="{{asset('pages/css/pos/pos.css')}}">
